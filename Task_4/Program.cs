...
namespace Task_4
{
    class Program
    {
        ...
        public static Regex EnglishLettersRegex = new Regex(@"w_[0-9]{2}[0-12]{1}[0-9]{4}", RegexOptions.Compiled);
        ...
        {       
            ...
            {
                if (Regex.Replace(Migrations.Resources.Resource.Ivanov_19112012.ToString().Trim(), @"\s+", @" ") != "")
                {
